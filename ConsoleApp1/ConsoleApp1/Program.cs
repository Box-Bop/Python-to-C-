...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (int numb1 in nums1)
            {
                foreach (int numb2 in nums2)
                {
                    if (numb1 == numb2)
                    {
            ...
            Console.WriteLine("Esimese list'i väikseim number: " + nums1.Min());
            Console.WriteLine("\n");
            Console.WriteLine("Teise list'i suurim number: " + nums2.Max());
            Console.WriteLine("Teise list'i väikseim number: " + nums2.Min());
